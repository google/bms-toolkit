...
###
GETOPT_MANDATORY="ora-swlib-bucket:,backup-dest:,instance-hostname:"
...
GETOPT_OPTIONAL="$GETOPT_OPTIONAL,instance-ssh-key:,ntp-pref:,inventory-file:,compatible-rdbms:"
